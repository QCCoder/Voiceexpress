...
- (UIButton *)tickImageView{
    if (!_tickImageView) {
        ...
        [tickImageView setImage:[UIImage ml_imageFromBundleNamed:@"icon_image_no"]];
        //        [tickImageView setImage: forState:UIControlStateNormal];
...
- (void)setAnimationRightTick:(BOOL)animationRightTick{
    ...
    if (self.pickType ==PickerTypeSelect) {
        if (self.isVideoType) {
