...
- (UIImageView *)groupImageView{
    if (!_groupImageView) {
        ...
        groupImageView.frame = CGRectMake(15, 5, 80, 80);
...
- (UILabel *)groupNameLabel{
    if (!_groupNameLabel) {
        ...
        groupNameLabel.frame = CGRectMake(105, 25, self.frame.size.width - 100, 20);
...
- (UILabel *)groupPicCountLabel{
    if (!_groupPicCountLabel) {
        ...
        groupPicCountLabel.frame = CGRectMake(105, 50, self.frame.size.width - 100, 20);
