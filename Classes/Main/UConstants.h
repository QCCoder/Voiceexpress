...
// 随机色
#define QCRandomColor RGBCOLOR(arc4random_uniform(256), arc4random_uniform(256), arc4random_uniform(256))
...
#define IS_RETINA_2 ([[UIScreen mainScreen] scale] >= 2.0)
#define IS_RETINA_3 ([[UIScreen mainScreen] scale] >= 3.0)
