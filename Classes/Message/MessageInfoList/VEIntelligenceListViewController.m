...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    [MobClick beginLogPageView:IntelligenceListView];
}
...
- (void)viewDidAppear:(BOOL)animated
{
    ...
    [MobClick endLogPageView:IntelligenceListView];
}
    ...
    @autoreleasepool {
        ...
        if (size > 0)
        {
            ...
            for (NSDictionary *singleItem in listData)
            {
                ...
                NSDictionary *intelligInfo = [VEUtility intelligenceInfoInBoxType:BoxTypeAllIntelligence
            ...
            if (1 == page)
            {
                ...
                double localNewestTimeReply = [VEUtility newestTimeAtIntelligenceColumnType:IntelligenceColumnAllIntelligence];
                if (maxNewestTimeReply > localNewestTimeReply)
                {
                    [VEUtility setNewestTime:maxNewestTimeReply atIntelligenceColumnType:IntelligenceColumnAllIntelligence];
                }
            }
...
//        else
//        {
            VECustomAlertTableViewCell * cell = [VECustomAlertTableViewCell cellWithTableView:tableView WithBackgroundView:self.cellSelectedBackgroundView];
